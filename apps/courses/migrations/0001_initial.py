    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('degree', models.CharField(choices=[('chu', '初级'), ('zhong', '中级'), ('gao', '高级')], max_length=6, verbose_name='难度')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('download', models.FileField(upload_to='courses/resource/%Y/%m', verbose_name='课程资源文件')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
